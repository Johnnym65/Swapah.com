...
$result = mysql_query("SELECT * FROM Auction WHERE Finished = 'no'  ORDER BY AuctionID DESC "); //order by AuctionID desc limit 6
...
echo "<font size = \"8\" face=\"arial\" color=\"#0080FF\"><b>Latest Auctions</b></font>";

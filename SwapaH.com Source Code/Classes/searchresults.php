...
Description: Displays auction search results
...
echo "<font size = \"8\" face=\"arial\" color=\"#0080FF\"><b>Search Results for </b></font><font size = \"4\" face=\"arial\" color=\"#0080FF\"><font size = \"4\" face=\"arial\" color=\"Grey\">\"".$search."\"";
echo "<table border = \"0\" width=\"720\" cellspacing=\"30\">";
$result10 = mysql_query("select * from Item where Title like '%$search%'");
while($row10 = mysql_fetch_array($result10))
{
$fitemid = $row10['Item_id'];

$result = mysql_query("SELECT * FROM Auction WHERE Finished = 'no' and Item_id = '$fitemid'  ORDER BY AuctionID DESC "); //order by AuctionID desc limit 6

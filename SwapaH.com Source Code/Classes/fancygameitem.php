...
Description: displays a users inventory in a fancybox for use with games
...
echo "<td VALIGN=\"middle\" ALIGN=\"center\">";
  ...
  echo "<form action=\"joinGame.php\" method=\"post\"><input type= \"hidden\" name=\"iid\" value="."$itemid". " />";

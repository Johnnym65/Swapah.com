...
Description: display results of category search
...
echo "<font size = \"8\" face=\"arial\" color=\"#0080FF\"><b>Category Search</b></font>";
echo "<table border = \"0\" width=\"720\" cellspacing=\"30\">";
$result10 = mysql_query("select * from Item where category = '$cat'");

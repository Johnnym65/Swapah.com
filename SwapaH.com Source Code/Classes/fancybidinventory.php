...
Description: displays a users inventory in a fancybox for use with making a bid
...
echo "<td VALIGN=\"middle\" ALIGN=\"center\">";
  ...
  {
  echo "<form action=\"Bidchecker.php\" method=\"post\"><input type= \"hidden\" name=\"iid\" value="."$itemid". " />";
